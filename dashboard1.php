...
<body>
  ...
  <div class="container">
    ...
    <div class="cards">
      <div class="card">
        <small>Users</small>
        <h2><?php echo $supplyBelow; ?> <small></small></h2>
      </div>

      <div class="card">
        <small>Overall Electricity Consumption</small>
        <h2><?php echo number_format($inventory); ?></h2>
      </div>

      <div class="card">
        <small>Overall Water Consumption</small>
        <h2><?php echo number_format($orderValue, 2); ?> <small></small></h2>
      </div>

      <div class="card">
        <small>Overall Emission</small>
        <h2><?php echo number_format($avgOrder); ?> <small></small></h2>
      </div>
    </div>
...
<?php
    ...
    // Check if the form is submitted
        ...
        $sql = "SELECT id, username, area FROM consumption ";
